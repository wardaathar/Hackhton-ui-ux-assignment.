...
import  cart5 from '../public/cart5.png';
      ...
      <main className="py-12 px-6 md:px-16 lg:px-28">
        ...
        <section className="mb-16 " >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           ...
           className="w-24 h-24 object-cover rounded mr-4"/>
              ...
              <div>
                <h3 className="text-lg font-medium">Soup</h3>
                <p className="text-sm text-gray-600">Chicken Soup With Ginger Garlic Sauces</p>
              </div>
        ...
        <section className="py-12 text-center">
          ...
          <div className="grid grid-cols-3 md:grid-cols-5 gap-6">
            <Image src={pic1} alt="Partner 1" className="w-[200px] md:w-[305px] md:h-[280px] cursor-pointer" />
            <Image src={pic2} alt="Partner 2"className="w-[200px] md:w-[305px] md:h-[280px] cursor-pointer"/>
            <Image src={pic3} alt="Partner 3"className="w-[200px] md:w-[305px] md:h-[280px] cursor-pointer"/>
            <Image src={pic5} alt="Partner 4" className="w-[200px] md:w-[305px] md:h-[280px] cursor-pointer" />
            <Image src={pic4} alt="Partner 5" className="w-[200px] md:w-[305px] md:h-[280px] cursor-pointer"/>
          </div>
        </section>
      </main>
    </div>
